...
Applicazione web interna a Intrawelt che automatizza la riconciliazione dei ruolini Eni:
carica un file Excel del cliente, lo arricchisce con i dati degli ordini di vendita letti da
Odoo via XML-RPC, e produce un foglio di controllo scaricabile. Il frontend React è servito
direttamente da Flask su una singola porta, accessibile in LAN ai soli tre indirizzi IP
statici autorizzati.
